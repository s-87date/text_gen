...
from transformers.optimization import AdamW, WarmupLinearSchedule # for Ubuntu
# from transformers.optimization import AdamW, get_linear_schedule_with_warmup # for iMac
...
def generate(tokenizer, device, max_iter=10, length=50, max_length=128,
    ...
    for _ in range(samples):
        ...
        # write seq to csv
        with open('./output/tachikoma_out.csv', 'a') as fd:
            fd.write(sampled_sequence + '\n')
